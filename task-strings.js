...
const param = parametrize("Javascript is the best");
console.log(param);
...
const sentence = giveSentenceForPerson({ name: "Obi-wan", position: "Jedi", age: 40, location: "Starwars universe" });
...
const rep = replace("Hello Javascript");
console.log(rep)